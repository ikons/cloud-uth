...
Έως τώρα ορίζατε χειροκίνητα `replicas` στο `Deployment`. Εδώ το cluster αποφασίζει αυτόματα πόσα Pods χρειάζονται. Αν στο 04 δούλευε ο rolling update ως "ελεγχόμενη αλλαγή έκδοσης", εδώ προστίθεται "ελεγχόμενη αλλαγή χωρητικότητας".
