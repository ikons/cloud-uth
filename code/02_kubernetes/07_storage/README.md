...
Όλα τα προηγούμενα παραδείγματα ήταν χωρίς κατάσταση: αν χανόταν το Pod, χάνονταν και τα τοπικά του δεδομένα — και αυτό ήταν αποδεκτό. Εδώ εισάγεται η διάκριση που είναι προαπαιτούμενη για βάσεις δεδομένων (επόμενο: `08_statefulsets`, και αργότερα `11_web-app` με PostgreSQL).
