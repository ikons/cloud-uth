...
Μια εφαρμογή χρειάζεται συχνά ρυθμίσεις ή αρχεία κειμένου που δεν είναι σκόπιμο να ενσωματωθούν μόνιμα στο container image. Για τον σκοπό αυτό το Kubernetes παρέχει τα `ConfigMaps`, τα οποία επιτρέπουν την εξωτερική παραμετροποίηση ενός φόρτου εργασίας.
